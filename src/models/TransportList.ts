...
export class TransportList {
    ...
    init() {
        ...
        transportAppItem.nameEN =  	'MTR Mobile (Railways)';
        transportAppItem.nameCN =  	'港铁 MTR Mobile (铁路)';
        transportAppItem.nameZH =  	'港鐵 MTR Mobile (鐵路)';
        ...
        transportAppItem.saveFlag = false
        transportAppItem.nameEN =  	'HKeTransport (Route)'
        transportAppItem.nameCN =  	'香港乘车易 (路线)'
        transportAppItem.nameZH =  	'香港乘車易 (路線)'
        ...
        transportAppItem.hotFlag = true
        transportAppItem.saveFlag = false
        transportAppItem.nameEN =  	'APP 1933 - KMB/LWB (Bus)'
        transportAppItem.nameCN =  	'APP 1933 - KMB/LWB (巴士)'
        transportAppItem.nameZH =  	'APP 1933 - KMB/LWB (巴士)'
